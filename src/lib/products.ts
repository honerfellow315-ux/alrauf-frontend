...
export const products: Product[] = [
  {
    ...
    price: 5500,
    oldPrice: 6500,
    img: "/wanted-by-abdul-rauf.png",
    category: "Wanted by Abdul Rauf",
    collection: "wanted",
    badge: "Bestseller",
    desc: "The signature scent of Wanted by Abdul Rauf. A monumental 100ml edition — bold saffron and rich oud wrapped in warm amber. Crafted for the one who leaves a mark.",
    top: "Saffron",
    heart: "Oud",
    base: "Amber",
  },
  {
    ...
    price: 4500,
    oldPrice: 5500,
    img: "/flora-by-malka.png",
    category: "Flora by Malka",
    collection: "flora",
    badge: "Limited Offer",
...
export const faqs = [
  ...
  { q: "Are your fragrances authentic?", a: "Yes, 100%. All ALRauf products are sourced directly from trusted suppliers. We never sell replicas or diluted products." },
  ...
  { q: "Can I cancel my order?", a: "Yes, you can cancel any order before it ships. Contact us on WhatsApp at 0336-3057013." },
];
