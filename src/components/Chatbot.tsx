...
const faqReplies: Record<string, string> = {
  ...
  wanted: "Wanted by Abdul Rauf is our signature men's collection — bold oud, leather, and amber.",
  flora: "Flora by Malka is our feminine line — rose, jasmine, vanilla, peony.",
  refund: "7-day return policy on unopened items. WhatsApp us to initiate.",
  contact: "WhatsApp: 0336-3057013 · IG: @Alrauffragrance.pk",
};

const chips = [
  { k: "delivery", l: "Delivery time" },
  { k: "payment", l: "Payments" },
  { k: "wanted", l: "Wanted line" },
  { k: "flora", l: "Flora line" },
  { k: "refund", l: "Refunds" },
  { k: "contact", l: "Contact" },
];
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
        ...
        {open && (
          ...
          >
            <div className="px-5 py-4 bg-gradient-gold text-ink flex items-center justify-between">
              <div>
                <p className="font-display text-lg leading-tight">ALRauf Support</p>
      ...
      <motion.button
        ...
        onClick={() => setOpen((o) => !o)}
        className="relative grid place-items-center w-14 h-14 rounded-full bg-gradient-gold text-ink shadow-[0_15px_40px_-10px_rgba(212,160,23,0.55)]"
        aria-label="Chat"
      >
