...
const logoAsset = { url: "/alrauf-logo.png" };
...
export function Footer() {
  return (
    <footer className="relative mt-32 border-t border-gold/15 bg-gradient-to-b from-ink to-night overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,oklch(0.78_0.14_82/0.08),transparent_60%)]" />
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 pt-20 pb-10 grid gap-12 lg:grid-cols-3">
        <div>
          <img src={logoAsset.url} alt="AlRauf Fragrances" className="h-16 w-auto mb-5" />
          ...
          <div className="mt-6 flex gap-3">
            <a
              href="https://instagram.com/alrauffragrance.pk"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="mailto:alrauffragrance1@gmail.com"
              aria-label="Email"
              className="grid place-items-center w-11 h-11 rounded-full bg-surface/40 border border-gold/20 hover:border-gold/60 hover:-translate-y-1 transition-all duration-500"
            >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-ash">
            <li className="flex items-start gap-3">
              ...
              <a href="mailto:alrauffragrance1@gmail.com" className="hover:text-gold transition-colors break-all">alrauffragrance1@gmail.com</a>
            </li>
            <li className="flex items-start gap-3">
              <WhatsAppIcon className="w-4 h-4 mt-0.5 shrink-0" />
              <a href="https://wa.me/923363057013" className="hover:text-gold transition-colors">0336-3057013</a>
            </li>
            <li className="flex items-start gap-3">
              <InstagramIcon className="w-4 h-4 mt-0.5 shrink-0" />
              <a href="https://instagram.com/alrauffragrance.pk" className="hover:text-gold transition-colors">@alrauffragrance.pk</a>
            </li>
            <li className="flex items-start gap-3">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 py-6 border-t border-gold/10 flex flex-wrap items-center justify-between gap-3 text-xs text-ash">
        <span>© {new Date().getFullYear()} ALRauf Fragrances. Crafted with care.</span>
