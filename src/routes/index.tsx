...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ALRauf Fragrances — Wear the Soul of Arabia" },
      { name: "description", content: "Luxury handcrafted Pakistani attars and perfumes. Wanted by Abdul Rauf & Flora by Malka." },
    ],
  }),
  component: Home,
});
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden min-h-[92vh] flex items-center">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_30%,oklch(0.78_0.14_82/0.15),transparent_55%)]" />
        </div>

        {/* Floating orbs */}
        <div className="pointer-events-none absolute -top-20 -left-20 w-[420px] h-[420px] rounded-full bg-[radial-gradient(circle,oklch(0.78_0.14_82/0.25),transparent_70%)] animate-smoke" />
        <div className="pointer-events-none absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle,oklch(0.58_0.13_72/0.25),transparent_70%)] animate-smoke" style={{ animationDelay: "3s" }} />
      ...
      <section className="relative mx-auto max-w-7xl px-6 sm:px-8 py-24">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          {[
            { title: "Wanted by Abdul Rauf", sub: "Bold · Dark · Magnetic", link: "/shop", grad: "from-amber-900/30 to-yellow-900/10" },
            { title: "Flora by Malka", sub: "Delicate · Romantic · Timeless", link: "/shop", grad: "from-rose-900/30 to-pink-900/10" },
          ].map((c, i) => (
            <motion.div key={i}
