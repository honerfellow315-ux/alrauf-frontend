...
function CodIcon() {
  return (
    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-amber-500 to-yellow-700 grid place-items-center shadow-[0_8px_20px_-6px_rgba(212,160,23,0.45)]">
...
function EasypaisaIcon() {
  return (
    <div className="w-12 h-12 rounded-lg bg-[#2c2848] grid place-items-center shadow-[0_8px_20px_-6px_rgba(0,166,81,0.45)] overflow-hidden p-1">
...
const methods = [
  ...
  { id: "easypaisa", Icon: EasypaisaIcon, t: "Easypaisa", d: "Transfer to 0336-3057013, upload screenshot" },
  { id: "jazzcash", Icon: JazzCashIcon, t: "JazzCash", d: "Transfer to 0336-3057013, upload screenshot" },
] as const;
                ...
                {methods.map((m) => (
                  <motion.button
                    ...
                    className={`text-left p-4 border transition-all ${
                      pm === m.id ? "border-gold bg-gold/10 shadow-[0_10px_30px_-12px_rgba(212,160,23,0.5)]" : "border-gold/20 hover:border-gold/50"
                    }`}>
                    <m.Icon />
