...
function AdminLogin() {
  ...
  return (
    <section className="min-h-[85vh] grid place-items-center px-6 py-16 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,oklch(0.78_0.14_82/0.15),transparent_60%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(120deg,transparent,oklch(0.78_0.14_82/0.04)_50%,transparent)] bg-[length:300%_100%] animate-[shimmer_8s_linear_infinite]" />

      <motion.div
        initial={{ opacity: 0, y: 40, scale: 0.96 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.7, ease: [0.2, 0.8, 0.2, 1] }}
        className="relative w-full max-w-md border border-gold/30 bg-surface/70 backdrop-blur-xl p-8 sm:p-10 shadow-[0_0_60px_-15px_rgba(212,160,23,0.35)]"
      >
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold to-transparent" />

        <img src={logoAsset.url} alt="AlRauf" className="h-16 w-auto mx-auto mb-6 drop-shadow-[0_0_24px_rgba(212,160,23,0.45)]" />
